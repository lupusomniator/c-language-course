...
Вытаскиваем первую вершину - "2". Это не наша искомая точка, смотрим ее соседий - увы или к счастью их нет и мы просто вытаскиваем "2" из очереди.

`| 3 | _ | _ | _ | _ |`
Теперь работаем с "3". Опять же это не конечная вершина, однако у нее есть соседи - "5", "6" и "4". Кладем их в очередь:
`| 5 | 6 | 4 | _ | _ |`
<p align="left">
