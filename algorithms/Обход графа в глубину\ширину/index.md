...
Обход в ширину или BFS работает совершенно иначе: вместо того, чтобы идти по какому-то пути до тупика, он за 1 шаг посещает всех соседей вершины "1", за следующий шаг всех соседей соседей "1" итак до тех пор, пока не найдется искомая вершина. Рассмотрим на том же примере:
<p align="left">
<img src="image/4.jpg" widdth="100" height="200">
</p>
